...
The current user ("${data.aws_caller_identity.current.user_id}") has full
control over these repositories. I will also grant push/pull/list/describe
permission to the C.I. IAM user ${aws_iam_user.application_ci_user.name}
HEREDOC
